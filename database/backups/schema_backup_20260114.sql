...
CREATE OR REPLACE FUNCTION "public"."is_round_member"("p_round_id" "uuid", "p_user_id" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_is_member BOOLEAN;
...
ALTER FUNCTION "public"."is_round_member"("p_round_id" "uuid", "p_user_id" "uuid") OWNER TO "postgres";
...
GRANT ALL ON FUNCTION "public"."is_round_member"("p_round_id" "uuid", "p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."is_round_member"("p_round_id" "uuid", "p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_round_member"("p_round_id" "uuid", "p_user_id" "uuid") TO "service_role";
